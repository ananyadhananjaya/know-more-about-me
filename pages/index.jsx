...
export default function Home() {
  return (
    <div className="flex h-screen">
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white opacity-90 m-auto">
        <div className="px-6 py-2">
          <span>Hey. I'm AX. I'm 23. To know more about me, click About. </span>{" "}
          <br /> <br />
          <span className=" inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 hover:bg-gray-600 hover:text-white">
            About
          </span>
        </div>
        <div className="px-6 py-2">
